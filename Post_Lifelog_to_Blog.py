...
def post_daylog_to_blog(day):
    ...
    import os
    print('Export Note:')
    html_export_path = '/Users/IceHe/Documents/Enex/lifelog/%s' \
                       % note_name.replace('/', '-')

    cmd = 'osascript /Users/IceHe/Documents/AppleScript/Evernote/note_export_html_with_nbname.scpt "%s" "%s" "%s"' % (
        note_name,
        notebook_name,
        html_export_path
    )
...
def post_time_stat_to_blog(day):
    ...
    import os
    print('Export Note:')
    html_export_path = '/Users/IceHe/Documents/Enex/lifelog_month_stat/%s' \
                       % note_name.replace('/', '-')
